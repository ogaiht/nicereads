            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <div>
                    ...
                    <div className="form-group">
                        ...
                        <Link to={paths.USERS} className="btn btn-link">Cancel</Link>
                    </div>
                </div>
            </div>
        );
...
const connectedUserComponent = connect(mapState, actionCreators)(UserComponent);
export { connectedUserComponent as UserComponent };